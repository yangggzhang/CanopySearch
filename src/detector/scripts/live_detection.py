...
class image_converter:
  ...
  def __init__(self):
    ...
    self.arm_pub = rospy.Publisher('push', Push, queue_size=1)
    ...
    self.T = np.array([[-0.0213565 ,  0.99967616, -0.01383723, -0.01541872],
                       [ 0.41591332,  0.02146953,  0.90915079, -0.54284319],
                       [ 0.90915346,  0.01366119, -0.41623715, -0.55857797],
                       [        0.0,         0.0,         0.0,         1.0]])
