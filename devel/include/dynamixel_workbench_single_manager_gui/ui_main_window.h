...
public:
    ...
    {
        MainWindowDesign->setWindowTitle(QApplication::translate("MainWindowDesign", "Dynamixel Workbench Single Manager", 0));
        ...
        tab_manager->setTabText(tab_manager->indexOf(tab_status), QApplication::translate("MainWindowDesign", "Dynamixel current state", 0));
        menu_File->setTitle(QApplication::translate("MainWindowDesign", "&App", 0));
        dockWidget->setWindowTitle(QApplication::translate("MainWindowDesign", "    Manager Command Panel", 0));
        dynamixel_information_group_box->setTitle(QApplication::translate("MainWindowDesign", "Dynamixel information", 0));
        get_device_name_label->setText(QApplication::translate("MainWindowDesign", "Device Name", 0));
        get_baud_rate_label->setText(QApplication::translate("MainWindowDesign", "Baudrate", 0));
        get_protocol_version_label->setText(QApplication::translate("MainWindowDesign", "Protocol Version", 0));
        get_model_name_label->setText(QApplication::translate("MainWindowDesign", "Model Name", 0));
        get_id_label->setText(QApplication::translate("MainWindowDesign", "ID", 0));
        dynamixel_command_group_box->setTitle(QApplication::translate("MainWindowDesign", "Dynamixel Command (Change to)", 0));
        set_id_label->setText(QApplication::translate("MainWindowDesign", "ID", 0));
        set_position_zero_push_button->setText(QApplication::translate("MainWindowDesign", "Position ZERO", 0));
        set_baud_rate_label->setText(QApplication::translate("MainWindowDesign", "Baudrate", 0));
        set_operating_mode_label->setText(QApplication::translate("MainWindowDesign", "Operating Mode", 0));
#ifndef QT_NO_ACCESSIBILITY
        set_id_combo_box->setAccessibleDescription(QString());
#endif // QT_NO_ACCESSIBILITY
        set_address_value_label->setText(QApplication::translate("MainWindowDesign", "Change Value", 0));
        torque_enable_toggle_button->setText(QApplication::translate("MainWindowDesign", "Torque Enable", 0));
#ifndef QT_NO_TOOLTIP
        factory_reset_push_button->setToolTip(QApplication::translate("MainWindowDesign", "Command for all data back to the factory settings values", 0));
#endif // QT_NO_TOOLTIP
        ...
        factory_reset_push_button->setText(QApplication::translate("MainWindowDesign", "Factory reset", 0));
#ifndef QT_NO_TOOLTIP
        reboot_push_button->setToolTip(QApplication::translate("MainWindowDesign", "Reboot a dynamixel (Only for supports protocol 2.0)", 0));
#endif // QT_NO_TOOLTIP
        reboot_push_button->setText(QApplication::translate("MainWindowDesign", "Reboot", 0));
